...
const MockExam: React.FC = () => {
    ...
    return (
        <div className="bg-gray-50 min-h-screen"> {/* Ensure background covers the full height of the screen */}
            {/* Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col md:col-span-2">
                        ...
                        <div className="bg-white p-4 rounded-lg mb-8">
                            ...
                            {mockExamData ? (
                                ...
                                <div className="px-6 py-4 text-gray-500 text-sm">Chưa có dữ liệu</div>
                            )}
                        </div>
                        ...
                        <div className="bg-white p-4 rounded-lg mb-8">
                            <h5 className="text-lg font-semibold mb-4">
                                ...
                                <div className="px-6 py-4 text-gray-500 text-sm">{user.data.name}, Lớp {user.data.grade}, {user.data.ward} {user.data.district} {user.data.province}</div>
                            </h5>
                    ...
                    <div className="flex flex-col md:col-span-1">
                        ...
                        <div className="bg-gray-200 p-4 rounded-lg">
                            <div className="text-sm text-gray-700">
                                <div className="mb-2">
                                    Phường/Xã: <span className="font-medium">{user.data?.ward || "Chưa có"}</span>
                                </div>
                                <div className="mb-2">
                                    Quận/Huyện: <span className="font-medium">{user.data?.district || "Chưa có"}</span>
                                </div>
                                <div className="mb-2">
                                    Thành phố/Tỉnh: <span className="font-medium">{user.data?.province || "Chưa có"}</span>
                                </div>
                            </div>
                        </div>
                    </div>
