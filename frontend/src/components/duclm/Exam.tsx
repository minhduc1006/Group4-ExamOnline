    ...
    useEffect(() => {
        ...
        if (examData?.examStart && examData?.examEnd) {
            ...
            if (Date.now() < startTime) {
                ...
                setTimeout(() => {
                    toast({
                        title: "Chưa đến giờ thi, vui lòng quay lại sau hoặc kiểm tra lịch thi của bạn!",
                        className: "text-white bg-yellow-500",
                    });
                }, 300);
                return;
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col md:col-span-1">
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <div className="ml-3">
                                <h4 className="text-lg font-semibold mb-2">{user.data?.name || "Người dùng"}</h4>
                                <div className="text-sm text-gray-700 mb-2">
                                    ID: <span className="font-medium">{user.data?.id || "N/A"}</span>
                                </div>
                                <div className="text-sm text-gray-700">
                                    Khối: <span className="font-medium">{user.data?.grade || "N/A"}</span>
                                </div>
                            </div>
                        </div>
