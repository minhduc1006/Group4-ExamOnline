  ...
  return (
    <div className="w-[1050px] mx-auto p-6">
      ...
      <h1 className="text-3xl font-bold text-center">
        Lịch Tự luyện và các vòng Thi chính thức EDU năm học 2024-2025
      </h1>
      <p className="text-sm text-gray-500 mt-4">Th.Bảy, 13/08/2022, 23:37</p>
      ...
      <div className="mt-6">
        ...
        <p className="font-bold mt-4">
          3.{" "}
          <span className="font-normal">
            Các tài khoản EDU đã sử dụng trong năm học 2022–2023 cần được thay
            đổi thông tin giáo dục để phù hợp với năm học mới, bắt đầu từ{" "}
            <span className="font-bold">ngày 15-08-2022.</span> Hướng dẫn thay
            đổi thông tin giáo dục xem tại:{" "}
            <a
              href="https://bit.ly/2VyMV7j"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-500 underline"
            >
              https://bit.ly/2VyMV7j
            </a>
          </span>
        </p>
        ...
        <p className="font-bold mt-4">
          ...
          <span className="font-normal">
            ...
            <a
              href="https://ioe.vn/cong-van/2915"
              className="text-blue-500 underline"
            >
              https://ioe.vn/cong-van/2915
            </a>
          </span>
        </p>
        <p className="mt-6">
      ...
      <div className="mt-6">
        ...
        <ul className="list-disc ml-6 mt-2">
          ...
          <li>
            Fanpage:{" "}
            <a
              href="https://www.fb.com/edu.vn"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-500 underline"
            >
              EDU.vn - Olympic Tiếng Anh trên Internet
            </a>
          </li>
          <li>
            Tổng đài: 1900.636.876 (hoạt động từ 8:30-17:30 từ thứ 2 đến thứ 6)
          </li>
          <li>Hotline: 0984.650.154 (hoạt động từ 18h00-21h00 T2-T6)</li>
        </ul>
      </div>
    </div>
  );
